...
from sumo_centralized_envs_new import SumoEnvCentralizedVel
...
def env_creator(config):
    ...
    return SumoEnvCentralizedVel(config)  # Return a gymnasium.Env instance.
...
if __name__ == "__main__":
    ...
    if checkpoint_path is not None:
        ...
        def logger_creator(config):
            ...
            logdir_prefix = (
                f"PPO_{env_cls}_{lane_str}_{av_percent_str}_{seed_str}_{timestr}"
            )
        ...
        register_env(env_cls, env_creator)
    ...
    num_training_steps = 2500  # 10000
    num_steps_between_saves = 50  # 250
